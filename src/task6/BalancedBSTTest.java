...
public class BalancedBSTTest {
    ...
    public void generateTreeTest2() {
        ...
        Assertions.assertEquals(3, balancedBST.Root.NodeKey);
        Assertions.assertEquals(2, balancedBST.Root.LeftChild.NodeKey);
        Assertions.assertEquals(5, balancedBST.Root.RightChild.NodeKey);
    }
